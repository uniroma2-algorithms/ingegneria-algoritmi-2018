...
if __name__ == "__main__":
    ...
    print("Tree has {} nodes".format(t.nodesNumber()))
    t.print()
    print("Sons of root are {}".format(t.sonsOf(t.root)))
    print("Root's degree is {}".format(t.degree(t.root)))
    t.cutLeft(t.root)
    print("Deleted left subtree from root")
    print("{} nodes left".format(t.nodesNumber()))
    t.print()
    print("Root's degree is now {}".format(t.degree(t.root)))
    t.cut(t.root)
