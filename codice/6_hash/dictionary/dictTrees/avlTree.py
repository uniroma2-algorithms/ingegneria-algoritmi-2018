...
if __name__ == "__main__":
    ...
    avl.print()
    print("After {} insertions, bst has {} elements".format(len(data), avl.size()))

    print("Pred of node with key 100 {}".format(avl.pred(100)))
    print("Pred of node with key 70 {}".format(avl.pred(70)))
    print("Tree max from root is {}".format(avl.max(avl.tree.root)))

    data.reverse()
    for s in data:
        print("Search for key {s} returned {}".format(avl.search(s)))
